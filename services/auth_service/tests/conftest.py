...
from quantum_hub.services.auth_service.main import app as auth_app
from quantum_hub.services.project_service.main import app as project_app
from quantum_hub.services.registry_service.main import app as registry_app
from quantum_hub.services.marketplace_service.main import app as marketplace_app
...
def test_client(mock_mongo_client):
    ...
    from quantum_hub.services.auth_service.main import app
    
    # Apply the patch to replace the MongoDB client
    with patch('quantum_hub.services.auth_service.main.client', mock_mongo_client):
        with patch('quantum_hub.services.auth_service.main.users_collection', mock_mongo_client['quantum_hub_test'].users):
...
def project_test_client(mock_mongo_client, test_user):
    ...
    from quantum_hub.services.project_service.main import app, get_current_user
    
    # Apply the patch to replace the MongoDB client
    with patch('quantum_hub.services.project_service.main.client', mock_mongo_client):
        with patch('quantum_hub.services.project_service.main.projects_collection', mock_mongo_client['quantum_hub_test'].projects):
...
def project_test_client_no_auth(mock_mongo_client):
    ...
    from quantum_hub.services.project_service.main import app
...
def registry_test_client(mock_mongo_client):
    ...
    from quantum_hub.services.registry_service.main import app
    
    # Apply the patch to replace the MongoDB client
    with patch('quantum_hub.services.registry_service.main.client', mock_mongo_client):
        with patch('quantum_hub.services.registry_service.main.registry_collection', mock_mongo_client['quantum_hub_test'].registry):
            client = TestClient(app)
            yield client
...
def marketplace_test_client(mock_mongo_client):
    ...
    from quantum_hub.services.marketplace_service.main import app
    
    # Apply the patch to replace the MongoDB client
    with patch('quantum_hub.services.marketplace_service.main.client', mock_mongo_client):
        with patch('quantum_hub.services.marketplace_service.main.offerings_collection', mock_mongo_client['quantum_hub_test'].offerings):
            client = TestClient(app)
            yield client
